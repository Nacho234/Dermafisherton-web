export const testimonials = [
  {
    quote:
      "Me explicaron todo con mucha claridad y el resultado fue súper natural.",
    name: "Paciente de Fisherton",
    detail: "Estética facial",
  },
  {
    quote:
      "El lugar es hermoso, la atención excelente y me sentí muy cómoda desde el primer momento.",
    name: "Paciente de Rosario",
    detail: "Primera consulta",
  },
  {
    quote:
      "Me gustó que primero evaluaran mi piel y me recomendaran lo que realmente necesitaba.",
    name: "Paciente de Fisherton",
...
export const differentiators = [
  {
    icon: "Stethoscope",
    title: "Criterio dermatológico",
    text: "Cada tratamiento parte de una evaluación profesional.",
  },
  {
    icon: "HandHeart",
    title: "Atención personalizada",
    text: "Diseñamos planes adaptados a tu piel y tus objetivos.",
  },
  {
    icon: "Sparkle",
    title: "Tecnología estética",
    text: "Protocolos modernos para tratamientos seguros y efectivos.",
  },
  {
    icon: "MapPinLine",
    title: "Ubicación en Fisherton",
    text: "Un espacio cómodo, privado y cercano.",
  },
];
...
export const process = [
  {
    ...
    text: "Evaluamos tu piel, antecedentes, objetivos y necesidades.",
  },
  {
    n: "02",
    title: "Plan personalizado",
    text: "Definimos el tratamiento más adecuado para vos.",
  },
  {
    n: "03",
    title: "Seguimiento",
    text: "Acompañamos la evolución y los cuidados posteriores.",
  },
];
